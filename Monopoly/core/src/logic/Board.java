...
public final class Board {
	...
	private static void initProperties() {
		...
		squares.set( 9, new Property( 9, "Pentonville Road",		120, new int[]{ 8,  40, 100,  300,  450,  600},  60,  50, Color.CYAN,	3));
		squares.set(11, new Property(11, "Pall Mall",				140, new int[]{10,  50, 150,  450,  625,  750},  70, 100, Color.PINK,	3));
		squares.set(13, new Property(13, "Whitehall",				140, new int[]{10,  50, 150,  450,  625,  750},  70, 100, Color.PINK,	3));
		squares.set(14, new Property(14, "Northumberland Avenue",	160, new int[]{12,  60, 180,  500,  700,  900},  80, 100, Color.PINK,	3));
		squares.set(16, new Property(16, "Bow Street",				180, new int[]{14,  70, 200,  550,  750,  950},  90, 100, Color.ORANGE,	3));
		squares.set(18, new Property(18, "Marlborough Street",		180, new int[]{14,  70, 200,  550,  750,  950},  90, 100, Color.ORANGE,	3));
		squares.set(19, new Property(19, "Vine Street",				200, new int[]{16,  80, 220,  600,  800, 1000}, 100, 100, Color.ORANGE,	3));
		squares.set(21, new Property(21, "The Strand",				220, new int[]{18,  90, 250,  700,  875, 1050}, 110, 150, Color.RED,	3));
		squares.set(23, new Property(23, "Fleet Street",			220, new int[]{18,  90, 250,  700,  875, 1050}, 110, 150, Color.RED,	3));
		squares.set(24, new Property(24, "Trafalgar Square",		240, new int[]{20, 100, 300,  750,  925, 1100}, 120, 150, Color.RED,	3));
		squares.set(26, new Property(26, "Leicester Square",		260, new int[]{22, 110, 330,  800,  975, 1150}, 150, 150, Color.YELLOW,	3));
		squares.set(27, new Property(27, "Coventry Street",			260, new int[]{22, 110, 330,  800,  975, 1150}, 150, 150, Color.YELLOW,	3));
		squares.set(29, new Property(29, "Piccadilly",				280, new int[]{22, 120, 360,  850, 1025, 1200}, 150, 140, Color.YELLOW,	3));
		squares.set(31, new Property(31, "Regent Street",			300, new int[]{26, 130, 390,  900, 1100, 1275}, 200, 150, Color.GREEN,	3));
		squares.set(32, new Property(32, "Oxford Street",			300, new int[]{26, 130, 390,  900, 1100, 1275}, 200, 150, Color.GREEN,	3));
		squares.set(34, new Property(34, "Bond Street",				320, new int[]{28, 150, 450, 1000, 1200, 1400}, 200, 160, Color.GREEN,	3));
